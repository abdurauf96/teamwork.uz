...
<div class="about_ru hide">  
    ...
    <div class="form-group{{ $errors->has('desc_ru') ? 'has-error' : ''}}">
        ...
        {!! Form::text('desc_ru', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control',  'rows'=>5]) !!}
...
<div class="about_en hide">
    ...
    <div class="form-group{{ $errors->has('desc_en') ? 'has-error' : ''}}">
        ...
        {!! Form::text('desc_en', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control',  'rows'=>5]) !!}
